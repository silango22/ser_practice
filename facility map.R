...
fac <-read.csv("C:/Users/sindana/Dropbox/Postdoc/Projects/Great Recession, Iron, PM v2/Data/fac_id.csv")
em<-read.csv("C:/Users/sindana/Dropbox/Postdoc/Projects/Great Recession, Iron, PM v2/Data/fac_emissions_so2_for_map2.csv")
ca<-st_read("C:/Users/sindana/Dropbox/PhD/Projects/People/Archive/Yi HW AP Greenspace/Data/exp_maps/exp_maps.shp")
...
#create map
setwd("C:/Users/sindana/Dropbox/Postdoc/Projects/Great Recession, Iron, PM v2/Manuscript/figures")
map<-ggplot(ca)+
